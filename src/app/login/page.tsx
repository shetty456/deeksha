        ...
        {sent ? (
          ...
          <div className="rounded-2xl border border-border bg-surface p-8 space-y-6">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 rounded-xl border border-border bg-surface-elevated px-4 py-3 text-sm font-medium text-text-primary hover:bg-border-subtle transition-colors disabled:opacity-50"
            >
              <GoogleIcon />
